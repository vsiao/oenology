...
import { winterVisitorCards } from "../game-data/visitors/winter/winterVisitorCards";
                ...
                switch (currentTurn.pendingAction.type) {
                    ...
                    case "playSummerVisitor":
                        if  (currentTurn.pendingAction.visitorId) {
                            const { name } = summerVisitorCards[currentTurn.pendingAction.visitorId];
                    ...
                    case "playWinterVisitor":
                        if  (currentTurn.pendingAction.visitorId) {
                            const { name } = winterVisitorCards[currentTurn.pendingAction.visitorId];
