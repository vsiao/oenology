...
const MeepleIcon: React.FunctionComponent<Props> = props => {
    return <svg className={props.className} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 100 100">
